...
const Vaccinations = ({ navigation, route }) => {
    ...
    //     {
    //         id: '1001',
    //         vaccineName: "3-in-1 Booster (Diphtheria, Tetanus, Polio)",
    //         dateAdministered: "Jul 2021",
    ...
    useEffect(async() =>{
        ...
        fetch(URL + "api/v1/patients/"+Patient_ID+"/history/vaccinations", {
            ...
            .then((json) => {
                 ...
                 setVaccinationHistoryData(json.data)
    ...
    const userTap = () => {
        navigation.navigate('VaccinationAddScreen',Patient_ID)
    }
                        ...
                        <View style={{ borderLeftWidth: 4, borderColor: '#008FFB', padding: 10, backgroundColor: 'white', borderRadius: 5, elevation: 5, width: '100%', height: 110, marginBottom:10 }}>
                            <View style={{flexDirection:'row', justifyContent: 'space-between',flex:1}}>
                                ...
                                <View style={{flex:1}}>
                                    ...
                                    <View style={{flex:1}}>
                                        <Text numberOfLines={2} style={{ fontSize: 18 }}>{item.vaccine.name} </Text>
                                
                                    </View>

                                    <View style={{ marginTop: 10 }}>
                                        <Text>Date Administered</Text>
                                        <Text style={{ fontSize: 14 }}>{moment(item.date).format('l')}</Text>
                                    </View>
            ...
            >
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ justifyContent: 'center' }}>
                        <Text style={{ fontFamily: 'NunitoSans-Bold', fontSize: 16 }}>Vaccination History</Text>
                    </View>
